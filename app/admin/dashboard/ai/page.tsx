    ...
    return (
        <AdminGuard>
            <div className="container mx-auto pt-28 md:pt-32 pb-12 px-4 space-y-6 animate-fade-in">
                <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 pb-2">
                    <div className="space-y-2">
                        <h1 className="text-4xl font-black text-slate-800 tracking-tight flex items-center gap-3">
                            <span className="text-primary">AI & Chatbot Analytics</span>
                        </h1>
                        <p className="text-slate-500 font-medium text-lg italic">Theo dõi hiệu suất Chatbot gợi ý và tỷ lệ nhấp chuột (CTR) của Hệ thống Gợi ý Cá nhân hóa.</p>
                    </div>
                ...
                <BotIntelligence stats={stats} />
                <RecommendationPerformance stats={stats} />
            </div>
        </AdminGuard>
    )
}
