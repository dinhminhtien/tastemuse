...
export default function ManageDataPage() {
    ...
    return (
        <AdminGuard>
            <div className="container mx-auto pt-28 md:pt-32 pb-24 px-4 min-h-screen space-y-8 animate-fade-in">
                <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
                    ...
                    <div className="flex items-center gap-3">
                        <Link href="/admin/dashboard">
                            <Button
                                variant="outline"
                                className="rounded-xl border-2 hover:bg-primary/5 transition-all font-bold"
                            >
                ...
                <Dialog open={isEditDialogOpen} onOpenChange={setIsEditDialogOpen}>
                    <DialogContent className="max-w-2xl border-2 rounded-2xl shadow-2xl p-0 overflow-hidden text-slate-900">
                        ...
                        <DialogHeader className="p-8 pb-4">
                            ...
                            <DialogDescription className="text-base font-semibold text-muted-foreground">
                                Chỉnh sửa thông tin chi tiết. Thay đổi sẽ được cập nhật vào database.
                            </DialogDescription>
                        </DialogHeader>
