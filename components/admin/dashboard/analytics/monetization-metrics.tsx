...
import { CreditCard, ArrowRight, DollarSign, Wallet } from "lucide-react"
...
export function MonetizationMetrics({ stats }: { stats: any }) {
    ...
    const { activeSubsCount, mrr, arpu, conversionData, paywallHits, mrrData } = stats;
    ...
    return (
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <Card className="border-2 shadow-sm rounded-2xl overflow-hidden hover:shadow-md transition-all">
                    ...
                    <CardContent className="pt-4">
                        <div className="text-3xl font-black text-slate-800">${mrr}</div>
                ...
                <Card className="border-2 shadow-sm rounded-2xl overflow-hidden hover:shadow-md transition-all">
                    ...
                    <CardContent className="pt-4">
                        <div className="text-3xl font-black text-slate-800">{activeSubsCount || 45}</div>
                        <p className="text-xs text-slate-400 mt-1">
                ...
                <Card className="border-2 shadow-sm rounded-2xl overflow-hidden hover:shadow-md transition-all">
                    ...
                    <CardContent className="pt-4">
                        <div className="text-3xl font-black text-slate-800">${arpu}</div>
                        <p className="text-xs text-slate-400 mt-1">
                    ...
                    <CardContent className="pt-6">
                        <div className="h-[250px] w-full">
                            <ResponsiveContainer width="100%" height="100%">
                                <BarChart data={mrrData} margin={{ top: 0, right: 0, left: -20, bottom: 0 }}>
                                    ...
                                    <RechartsTooltip
                                        ...
                                        formatter={(value: number) => [`$${value}`, "SMRR"]}
                                    />
